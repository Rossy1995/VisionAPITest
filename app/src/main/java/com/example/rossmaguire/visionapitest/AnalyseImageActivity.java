...
public class AnalyseImageActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyse_image);
    ...
    public void selectImage(View view) {
        ...
        Intent intent;
        intent = new Intent(AnalyseImageActivity.this, SelectImageActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d("AnalyseImageActivity", "onActivityResult");
        switch (requestCode) {
            case REQUEST_SELECT_IMAGE:
                if (resultCode == RESULT_OK) {
                    ...
                    if (mBitmap != null) {
                        ...
                        // Add detection log.
                        Log.d("AnalyseImageActivity", "Image: " + mImageUri + " resized to " + mBitmap.getWidth()
                                + "x" + mBitmap.getHeight());
    ...
    private class doRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String data) {
            ...
            if (e != null) {
                ...
                JsonArray detectedCelebs = result.result.get("landmarks").getAsJsonArray();
